...
if option == 1 and typ == 1:
	...
	if varknown != 1:
		...
		print (f"\\\\\\text{{Confidence interval = }}({mean} - {z}\\sqrt{{{round((sd1**2)/n1, 4)} + {round((sd2**2)/n2, 4)}}}, {mean} + {z}\\sqrt{{{round((sd1**2)/n1, 4)} + {round((sd2**2)/n2, 4)}}})")
		print (f"\\\\\\text{{Confidence interval = }}({mean} - {z}\\sqrt{{{round((sd1**2)/n1, 4) + round((sd2**2)/n2, 4)}}}, {mean} + {z}\\sqrt{{{round((sd1**2)/n1, 4) + round((sd2**2)/n2, 4)}}})")
		print (f"\\\\\\text{{Confidence interval = }}({mean} - {z}({round((((sd1**2)/n1)+((sd2**2)/n2))**0.5, 4)}), {mean} + {z}({round((((sd1**2)/n1)+((sd2**2)/n2))**0.5, 4)}))")
		print (f"Required confidence interval = ({mean}-{E}, {mean}+{E})")
		print (f"Required confidence interval = ({ll}, {ul})")
