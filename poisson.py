...
if MorL == 1:
	for i in range(parts):
		...
		if ty == 2:
			...
			print ("P(X < " + str(x) + ") = ", end=" ")
			for k in range(x-1):
				print(f"\\frac{{e^{{-{mean}}}}} {mean}^{{{k}}}{{{x-1}!}} + ", end=" ")
			print(f"\\frac{{e^{{-{mean}}} {mean}^{{{x-1}}}}}{{{x-1}!}}")
			print ("P(X < " + str(x) + ") = ", end=" ")
			for l in range(x-1):
				print(f"{round(prob(mean, l), 8)} + ", end=" ")
			print(f"{round(prob(mean, x-1), 4)}")
			print ("\\\\P(X < " + str(x) + ") = " + str(ans))
		if ty == 3:
			x = int(input(chr(sec) + ") " + "x = "))
			sec += 1 
			...
			print ("P(X \\le " + str(x) + ") = ", end=" ")
			for k in range(x):
				print(f"\\frac{{e^{{-{mean}}}}} {mean}^{{{k}}}{{{k}!}} + ", end=" ")
			print(f"\\frac{{e^{{-{mean}}} {mean}^{{{x}}}}}{{{x}!}}")
			print ("P(X \\le " + str(x) + ") = ", end=" ")
			for l in range(x):
				print(f"{round(prob(mean, l), 4)} + ", end=" ")
			print(f"{round(prob(mean, x), 4)}")
